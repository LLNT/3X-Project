...
class Info(cocos.layer.ColorLayer):
    ...
    def info_display(self, person):
        ...
        self.add(self.spr)
        self.visible = True
        self.name = Text(p.name,(self.width*3/4, self.height*3/4),(127, 255, 170, 255))
        self.add(self.name)
        hp = str(p.ability['HP'])
        self.hp = Text('HP:'+hp,(self.width*1/8, self.height*1/4),(127, 255, 170, 255))
        mhp = str(p.ability['MHP'])
        self.mhp = Text('MHP:' + mhp,(self.width*1/8, self.height*1/8),(127, 255, 170, 255))
        self.add(self.hp)
        self.add(self.mhp)
